...
exports.getFractionalOctaveFrequencies = getFractionalOctaveFrequencies;
exports.fractionalOctaveSmoothing = fractionalOctaveSmoothing;
const math_1 = require("./math");
console.debug("Fractional Octave Smoothing module loaded");
function getFractionalOctaveFrequencies(fraction, f_low = 20, f_high = 24000, fftSize) {
    if (fraction <= 0) {
    ...
    let frequencies = (0, math_1.logspace)(f_low, f_high, num_points);
