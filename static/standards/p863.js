...
exports.POLQAMode = void 0;
exports.polqaAnalysis = polqaAnalysis;
exports.polqaSingleEnded = polqaSingleEnded;
...
(function (POLQAMode) {
    POLQAMode["NB"] = "NB";
    POLQAMode["WB"] = "WB";
    POLQAMode["SWB"] = "SWB"; // Super-wideband (50-14000 Hz)
})(POLQAMode || (exports.POLQAMode = POLQAMode = {}));
/**
...
function cognitiveModel(spectralDistortion, temporalDistortion, snr) {
    ...
    const combinedDistortion = SPECTRAL_WEIGHT * spectralDistortion +
 ...
 */
function polqaAnalysis(reference, degraded, config) {
 ...
 */
function polqaSingleEnded(signal, config) {
    const sampleRate = config.sampleRate;
    const frameSizeSamples = Math.floor((FRAME_SIZE_MS / 1000) * sampleRate);
 ...
 */
function getRecommendedConfig(sampleRate) {
    if (sampleRate >= 32000) {
